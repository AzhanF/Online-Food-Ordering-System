            ...
            if (jwtFilter.isAdmin()) {
                if (this.validateProductMap(requestMap, true)) {
                    ...
                    if (productDaoById.isPresent()) {
                        ...
                        return FoodUtils.getResponseEntity(
                                "Product with id " + requestMap.get("id") + " does not exists", HttpStatus.NOT_FOUND);
                } else
                    return FoodUtils.getResponseEntity(FoodConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
            } else
                return FoodUtils.getResponseEntity(FoodConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (product.isPresent()) {
                    ...
                    return FoodUtils.getResponseEntity("Product with id " + id + " does not exists",
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (product.isPresent()) {
                    ...
                    return FoodUtils.getResponseEntity("Product with id " + requestMap.get("id") + " does not exists",
                            HttpStatus.NOT_FOUND);
            } else
                return FoodUtils.getResponseEntity(FoodConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
        } catch (Exception exception) {
